...
if __name__ == "__main__":
    ...
    klipsub_result_dir = '/disk1/zimmerman/GJ504/apr21_longL/klipsub_results'
    ...
    klipsub_res_img_hdulist = pyfits.open(klipsub_res_img_fname, 'readonly')
    ...
    #posguess_rho = 118.
    posguess_rho = 238.
    posguess_theta = -33. # CCW of N (up in derotated image)
    #posguess_rho = 100.
    ...
    print "p0:", p0
    #
    # Write the guess model of the source to an image
    #
#    guess_srcmodel_img = superpose_srcmodel(data_img = np.zeros(fr_shape), srcmodel_img = 0.514*crop_synthpsf_img,
#                                            srcmodel_destxy = ( cent_xy[0] + 64.82852534, cent_xy[1] + 98.39205902 ),
#                                            srcmodel_centxy = crop_synthpsf_cent_xy)
    guess_srcmodel_img = superpose_srcmodel(data_img = np.zeros(fr_shape), srcmodel_img = ampguess*crop_synthpsf_img,
